...
public class C08_JSONObjectVerileriCagirma {
    ...
    public void jsonPath01(){
        ...
        System.out.println("tel no :" +kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(0)
                           .get("number"));

        System.out.println("tel turu :" +kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(0)
                .get("type"));

        System.out.println("tel no :" +kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(1)
                .get("number"));
        System.out.println("tel turu :" +kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(1)
                .get("type"));
